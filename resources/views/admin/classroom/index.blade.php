    ...
    <script>
        ...
        document.querySelectorAll('.deleteBtn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                deleteModal.querySelector('form').action = `/admin/classroom/${btn.dataset.id}`;
            });
        });

        // Tombol close modal delete
        deleteModal.querySelectorAll('[data-modal-toggle="deleteModal"]').forEach(btn => {
